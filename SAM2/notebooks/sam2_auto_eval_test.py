...
ANNOTATION_PATH = r"/research/d1/rshr/ttzhang/d2/saliency_dataset/ILSO1K/test300.json"
IMAGE_PATH = r"/research/d1/rshr/ttzhang/d2/saliency_dataset/ILSO1K/test300"
...
if __name__ == '__main__':
    ...
    # ------------------------- Save the results -------------------------
    with open("../SAM2_auto_eval_tiny_test300.json", "w") as f:
        json.dump(dataset_results, f)

    # ------------------------- Evaluate the results ---------------------
    cocoDt = cocoGT.loadRes("../SAM2_auto_eval_tiny_test300.json")
