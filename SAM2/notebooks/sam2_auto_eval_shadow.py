...
if __name__ == '__main__':
    ...
    parser.add_argument('--annotation_path', type=str, required=True, default="/research/d1/rshr/ttzhang/d2/dataset/shadow/SOBA/annotations/SOBA_challenge_v2.json" ,help='Path to the annotation file')
    parser.add_argument('--image_path', type=str, required=True, default='/research/d1/rshr/ttzhang/d2/dataset/shadow/SOBA/SOBA/challenge', help='Path to the image directory')
    parser.add_argument('--model_cfg', type=str, default='sam2_hiera_l.yaml', help='Type of model to use')
    parser.add_argument('--device', type=str, default='cuda', help='Device to use for computation')
    parser.add_argument('--sam2_checkpoint', type=str, required=True, default='../checkpoints/sam2_hiera_large.pt',help='Path to the SAM checkpoint file')
    parser.add_argument('--save_json', type=str, required=True, default='sam2_auto_soba_challenge_l.json', help='Filename to save JSON results')
