...
output_folder = "/media/pjl307/data/experiment/ZZJ/DIS/DIS_SAM2_Results/Hiera_B+/DIS-VD"
...
output_folder = "/media/pjl307/data/experiment/ZZJ/DIS/DIS_SAM2_Results/Hiera_B+/DIS-TE1"
# Process all images in the input folder
process_images_in_folder(input_folder, output_folder)

# Set the paths to your input and output folders
input_folder = "/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE2/im"
output_folder = "/media/pjl307/data/experiment/ZZJ/DIS/DIS_SAM2_Results/Hiera_B+/DIS-TE2"
# Process all images in the input folder
process_images_in_folder(input_folder, output_folder)

# Set the paths to your input and output folders
input_folder = "/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE3/im"
output_folder = "/media/pjl307/data/experiment/ZZJ/DIS/DIS_SAM2_Results/Hiera_B+/DIS-TE3"
# Process all images in the input folder
process_images_in_folder(input_folder, output_folder)

# Set the paths to your input and output folders
input_folder = "/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE4/im"
output_folder = "/media/pjl307/data/experiment/ZZJ/DIS/DIS_SAM2_Results/Hiera_B+/DIS-TE4"
# Process all images in the input folder
process_images_in_folder(input_folder, output_folder)
