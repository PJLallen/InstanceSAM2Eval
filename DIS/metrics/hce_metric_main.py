...
def main():
    ...
    # gt_root = r"../gt"
    gt_ske_root = ""
    # pred_root =  r"../predictions"

    # pred_root = r"/home/pjl307/下载/Model_80/te4"
    # gt_root = r"/media/pjl307/data/experiment/ZZJ/DIS/DIS5K/DIS-TE4/gt"

    #VD
    print("---------VD----------")
    pred_root ='/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-VD/SAM1Prediction-vit-b'
    gt_root ='/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-VD/gt'
    print("The average HCE metric: ", compute_hce(pred_root, gt_root, gt_ske_root))
    pred_root = '/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-VD/SAM1Prediction-vit-l'
    gt_root = '/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-VD/gt'
    print("The average HCE metric: ", compute_hce(pred_root, gt_root, gt_ske_root))
    pred_root = '/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-VD/SAM1Prediction-vit-h'
    gt_root = '/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-VD/gt'
    print("The average HCE metric: ", compute_hce(pred_root, gt_root, gt_ske_root))


    print("---------TE1----------")
    pred_root ='/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE1/SAM1Prediction-vit-b'
    gt_root ='/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE1/gt'
    print("The average HCE metric: ", compute_hce(pred_root, gt_root, gt_ske_root))
    pred_root = '/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE1/SAM1Prediction-vit-l'
    gt_root = '/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE1/gt'
    print("The average HCE metric: ", compute_hce(pred_root, gt_root, gt_ske_root))
    pred_root = '/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE1/SAM1Prediction-vit-h'
    gt_root = '/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE1/gt'
    print("The average HCE metric: ", compute_hce(pred_root, gt_root, gt_ske_root))


    print("---------TE2----------")
    pred_root ='/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE2/SAM1Prediction-vit-b'
    gt_root ='/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE2/gt'
    print("The average HCE metric: ", compute_hce(pred_root, gt_root, gt_ske_root))
    pred_root = '/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE2/SAM1Prediction-vit-l'
    gt_root = '/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE2/gt'
    print("The average HCE metric: ", compute_hce(pred_root, gt_root, gt_ske_root))
    pred_root = '/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE2/SAM1Prediction-vit-h'
    gt_root = '/media/pjl307/data/experiment/ZZJ/DIS/DIS5K-dataset/DIS-TE2/gt'
    print("The average HCE metric: ", compute_hce(pred_root, gt_root, gt_ske_root))
